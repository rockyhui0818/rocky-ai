...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (payload?.async || payload?.background_job || payload?.mode === "job") {
      return createReviewAnalysisJob(req, res, payload);
    }
...
async function createReviewAnalysisJob(req, res, payload) {
